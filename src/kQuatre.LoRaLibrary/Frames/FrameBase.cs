...
namespace fr.guiet.lora.frames
{
    public abstract class FrameBase
    {
        ...
        public double FlightTime
        {
            get
            {
                return Convert.ToInt32(_arrivedTime - _startTime);
            }
        }
        ...
        protected FrameBase(byte frameId, string frameOrder, string senderAddress, string receiverAddress, int totalTimeOut)
        ...
        protected FrameBase(byte frameId, string frameOrder, string senderAddress, string receiverAddress, int totalTimeOut, int frameSentMaxRetry)
            : this(frameId, frameOrder, senderAddress, receiverAddress, totalTimeOut)
        {
        ...
        {
            string frameOrder = string.Format("{0}", _frameOrder);
